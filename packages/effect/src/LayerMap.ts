 ...
 * @example
 * ```ts
 * import { LayerMap, Layer, ServiceMap, Effect } from "effect"
 *
 ...
 * @example
 * ```ts
 * import { LayerMap, Layer, ServiceMap, Effect, Scope } from "effect"
 *
 * // Define a service key
 * const DatabaseService = ServiceMap.Key<{
 *   readonly query: (sql: string) => Effect.Effect<string>
 ...
 * @example
 * ```ts
 * import { LayerMap, Layer, ServiceMap, Effect, Console } from "effect"
 *
 * // Define a service key
 ...
 * @example
 * ```ts
 * import { LayerMap, Layer, ServiceMap } from "effect"
 *
...
export declare namespace Service {
   ...
   * @example
   * ```ts
   * import { LayerMap, Layer, ServiceMap, Effect, Data } from "effect"
   *
